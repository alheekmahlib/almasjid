...
struct prayer_widgetExtensionEntryView : View {
    ...
    var fajrProgress: Double {
        // من بعد الفجر إلى الفجر القادم (دورة يومية)
        let now = entry.date
    ...
    var maghribProgress: Double {
        // من بعد المغرب إلى المغرب القادم (دورة يومية)
        let now = entry.date
    ...
    var fajrPrayerTime: String {
        // نفس فكرة nextPrayerTime ولكن مخصصة للفجر
    ...
    var maghribPrayerTime: String {
        // نفس فكرة nextPrayerTime ولكن مخصصة للمغرب
