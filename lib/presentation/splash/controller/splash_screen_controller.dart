...
class SplashScreenController extends GetxController {
  ...
  Widget get customWidget {
    switch (state.customWidgetIndex.value) {
      case 0:
        return AnimatedDrawingWidget(customColor: Get.theme.canvasColor);
      case 1:
  ...
  Future<void> activateNotifications() async {
    try {
      ...
      // توحيد المنصات: requistPermissions يهيئ الخدمة ويطلب الأذونات داخلياً.
      final granted = await NotifyHelper().requistPermissions();
      // حفظ حالة الصلاحية
