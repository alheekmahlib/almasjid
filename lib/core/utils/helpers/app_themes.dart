...
final ThemeData blueTheme = ThemeData.light(
  ...
  dialogBackgroundColor: const Color(0xffEFF4FE),
  dividerColor: const Color(0xff31493C),
  highlightColor: const Color(0xff31493C).withValues(alpha: 0.25),
  indicatorColor: const Color(0xff31493C),
...
final ThemeData darkTheme = ThemeData.dark(
  ...
  highlightColor: const Color(0xff001A23).withValues(alpha: 0.25),
  indicatorColor: const Color(0xff001A23),
